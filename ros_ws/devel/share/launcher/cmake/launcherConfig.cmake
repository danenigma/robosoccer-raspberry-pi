...
if("TRUE" STREQUAL "TRUE")
  set(launcher_SOURCE_PREFIX /home/pi/Desktop/myrobot/ros_ws/src/launcher)
  set(launcher_DEVEL_PREFIX /home/pi/Desktop/myrobot/ros_ws/devel)
  set(launcher_INSTALL_PREFIX "")
  set(launcher_PREFIX ${launcher_DEVEL_PREFIX})
else()
  set(launcher_SOURCE_PREFIX "")
  set(launcher_DEVEL_PREFIX "")
  set(launcher_INSTALL_PREFIX /home/pi/Desktop/myrobot/ros_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'launcher' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'pi <pi@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'launcher' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/Desktop/myrobot/ros_ws/src/launcher/${idir}'.  Ask the maintainer 'pi <pi@todo.todo>' to fix it.")
    endif()
